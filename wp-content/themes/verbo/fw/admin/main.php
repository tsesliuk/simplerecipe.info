...
class mytheme_admin {
    ...
    static function load_js(){
        if( is_admin( ) ){
            wp_register_script( 'my-fields' ,  get_template_directory_uri() . '/media/admin/js/fields.js' , array( 'jquery' , 'media-upload' , 'thickbox' ) ) ;
            wp_register_script( 'my-tools' ,  get_template_directory_uri() . '/media/admin/js/tools.js' ) ;
            ...
            wp_enqueue_script( 'my-fields' );
            wp_enqueue_script( 'my-tools' );
        }
    }
};
