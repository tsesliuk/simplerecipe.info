...
class RTE_Plugino extends RTE_i8 {
	...
	function _uninstalling()
	{
		...
		return isset($_POST['action']) && $_POST['action'] == 'delete-selected' && $_POST['verify-delete'] == 1	&& in_array(plugin_basename($this->__FILE__), $_POST['checked']); 
	}
