<div class="mythemes-header overflow-wrapper" style="background-color: <?php echo myThemes::get( 'mask-color' ); ?>; height: <?php echo myThemes::get( 'header-height' ); ?>px;">
    <div class="img-background" style="background-image: url(<?php echo get_header_image(); ?>); background-attachment: fixed; background-size: cover; background-position: center center; height: <?php echo myThemes::get( 'header-height' ); ?>px;"></div>
    <div class="valign-cell-wrapper" style="background: rgba( <?php echo mythemes_hex2rgb( myThemes::get( 'mask-color' ) ); ?>, <?php echo (float)myThemes::get( 'mask-opacity' ) / 100; ?> );">
