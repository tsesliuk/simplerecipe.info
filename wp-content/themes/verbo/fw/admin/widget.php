<?php
    ...
    /* SLIDESHOW */
    $wgd .= '<div class="mythemes-widget mythemes-slideshow">';
    $wgd .= '<div class="mythemes-container">';
    $wgd .= '<div class="mythemes-slideshow-item current"><a href="http://mythem.es/item/verbo-premium-wordpress-theme/" title="myThem.es - Verbo Premium Responsive WordPress Theme"><img src="' . get_template_directory_uri() . '/media/admin/images/mythemes-verbo-premium.png"/></a></div>';
    $wgd .= '<div class="mythemes-slideshow-item"><a href="http://mythem.es/forums/topic/general-about-customizations/" title="myThem.es - general about customizations"><img src="' . get_template_directory_uri() . '/media/admin/images/mythemes-customizations.png"/></a></div>';
    $wgd .= '<div class="mythemes-slideshow-item"><a href="http://mythem.es/contact/" title="myThem.es - contact for support or customizations"><img src="' . get_template_directory_uri() . '/media/admin/images/mythemes-support.png"/></a></div>';
    $wgd .= '</div>';
    $wgd .= '<nav class="mythemes-slideshow-pagination">';
    $wgd .= '<ul>';
    $wgd .= '<li class="current"><a href="javascript:void(null);"></a></li>';
    $wgd .= '<li><a href="javascript:void(null);"></a></li>';
    $wgd .= '<li><a href="javascript:void(null);"></a></li>';
    $wgd .= '</ul>';
    $wgd .= '</nav>';
    $wgd .= '</div>';
    ...
    //*[@id="wpbody-content"]/div[2]/table/tbody/tr/td[2]/div[2]/div[1]
