...
function wck_cfc_add_side_boxes(){
	add_meta_box( 'wck-cfc-side', 'Wordpress Creation Kit Pro', 'wck_cfc_side_box_one', 'wck-meta-box', 'side', 'low' );
	add_meta_box( 'wck-cfc-side-two', 'Wordpress Creation Kit', 'wck_cfc_side_box_two', 'wck-meta-box', 'side', 'low' );
}
