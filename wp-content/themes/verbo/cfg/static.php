<?php
    ...
    $cfg = array(
        ...
        'pages' => array(
            'projects' => array(
                'pageID' => myThemes::get( 'projects-page' ),
                'content' => array(
                    'location' => get_template_directory() . '/cfg/templates/page/projects.php'
                )
            ),
        ),
        ...
        /* MENUS */
        'menus' => array(
            'header-first' => __( 'Header first menu' , 'myThemes' )
        ),
        ...
        'custom-sidebars' => 'sidebars-list',
        'actions' => array(
            'wp_ajax_attach_to_post' => array( 'myThemes' , 'attach_to_post' )
        ),
    );
?>