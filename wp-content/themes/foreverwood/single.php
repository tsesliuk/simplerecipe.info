...
<?php foreverwood_get_display_image_post(); ?>
<?php if ( $foreverwood_options_db['foreverwood_display_meta_post'] != 'Hide' ) { ?>
        <p class="post-meta">
...
<?php endwhile; endif; ?>
<?php if ( $foreverwood_options_db['foreverwood_next_preview_post'] != 'Hide' ) { ?>
<?php foreverwood_prev_next('foreverwood-post-nav'); ?>
<?php } ?> 
